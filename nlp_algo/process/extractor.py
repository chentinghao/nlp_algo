...
# __all__ = ['extract_email', 'remove_chinese','extract_cellphone', 'extract_cellphone', 'extract_cellphone_location',
...
class Extractor(object):
    ...
    #     eng_split_texts = [''.join(g) for k, g in itertools.groupby(eng_texts, sep.__contains__) if not k]
